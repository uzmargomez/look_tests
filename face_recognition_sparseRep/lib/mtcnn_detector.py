...
class MtcnnDetector(object):
    ...
    def list2colmatrix(self, pts_list):
        ...
        colMat = np.asarray(colMat).transpose()
        return colMat
    ...
    def find_tfrom_between_shapes(self, from_shape, to_shape):
        ...
        sigma_from = 0.0
        sigma_to = 0.0
        cov = np.asarray([[0.0, 0.0], [0.0, 0.0]])
    ...
    def extract_image_chips(self, img, points, desired_size=256, padding=0.1):
        ...
        for p in points:
            ...
            probe_vec = np.asarray([1.0, 0.0]).transpose()
